...
def click_effectiveness_button():
    if button_left_main_eff.image == button_off_eff:
        ...
        def show_plot():
                ...
                print (tips_err)
                plot_data.wait
                os.chdir(f"/home/yinbo/Desktop/comp6130/final project/final project/FedGen-main/figs/{dataset_var.get()}/ratio{r_var.get()}/") 
...
def click_fairness_button():
    ...
    if button_left_main_fa.image == button_off_fa:
        ...
        def check_fairness_dataset():
            os.chdir("/home/yinbo/Desktop/comp6130/final project/final project/easyFL-main/fedtask") 
        ...
        def generate_fairness_dataset():
            os.chdir("/home/yinbo/Desktop/comp6130/final project/final project/easyFL-main")
        ...
        def fairness_plot_result():
                os.chdir("/home/yinbo/Desktop/comp6130/final project/final project/easyFL-main/utils")
