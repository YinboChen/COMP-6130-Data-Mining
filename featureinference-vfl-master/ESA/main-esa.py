...
if __name__=='__main__':  
    ...
    for it in range(trials):
        ...
        print("Attack trial {} / {}".format(it+1, trials))
    ...
    print(f'Back propagation attack\t {trials}-Avg MSE:\t{back_prop_mse.avg:4f}')
    print(f'Random guess attack\t {trials}-Avg MSE:\t{random_guess_mse.avg:4f}')
