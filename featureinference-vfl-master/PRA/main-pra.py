...
if __name__=='__main__':  
    ...
    for perexp in range(trials):
        ...
        print("Attack trial {} / {}".format(perexp+1, trials))
    ...
    print(f'Path restriction attack\t {trials}-Avg accuracy:\t{path_restriction_accuracy.avg:4f}')
    print(f'Random guess attack\t {trials}-Avg accuracy:\t{random_guess_accuracy.avg:4f}')
